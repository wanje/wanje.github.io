...
;(function(undefined) {
    if (String.prototype.trim === undefined) // fix for iOS 3.2，如果字符串的trim方法未定义，则写一个strim方法，这在不同的浏览器或版本实现不同(有的提供该方法，有的不提供该方法)
    ...
    //这个方法的作用就是类似一个累计处理的作用，将前一条数据的处理结果用作下一次的处理
