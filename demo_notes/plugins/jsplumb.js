(function () {
    ...
    function d(a, b, d, e) {
        var f, g, h = b / a, i = d / a, j = e / a, k = (3 * i - Math.pow(h, 2)) / 9,
                l = (9 * h * i - 27 * j - 2 * Math.pow(h, 3)) / 54, m = Math.pow(k, 3) + Math.pow(l, 2), n = [];
    ...
    var e = {
    ...
    }, f = 64, g = Math.pow(2, -f - 1), h = function (a, b) {
        ...
        return i = e.subtract(a, b[f]), p = e.square(i), l > p && (l = p, m = 1), {location: m, distance: l}
    }, i = function (a, b) {
        var c = h(a, b);
        return {point: o(b, b.length - 1, c.location, null, null), location: c.location}
    }, j = function (a, b) {
        for (var c = b.length - 1, d = 2 * c - 1, f = [], g = [], h = [], i = [], j = [[1, .6, .3, .1], [.4, .6, .6, .4], [.1, .3, .6, 1]], k = 0; c >= k; k++)f[k] = e.subtract(b[k], a);
        for (var k = 0; c - 1 >= k; k++)g[k] = e.subtract(b[k + 1], b[k]), g[k] = e.scale(g[k], 3);
        for (var l = 0; c - 1 >= l; l++)for (var m = 0; c >= m; m++)h[l] || (h[l] = []), h[l][m] = e.dotProduct(g[l], f[m]);
        for (k = 0; d >= k; k++)i[k] || (i[k] = []), i[k].y = 0, i[k].x = parseFloat(k) / d;
        for (var n = c, o = c - 1, p = 0; n + o >= p; p++) {
            var q = Math.max(0, p - o), r = Math.min(p, n);
            for (k = q; r >= k; k++) {
                var s = p - k;
                i[k + s].y += h[s][k] * j[s][k]
            }
        ...
        if (t(a))return 0;
        for (var b = r(a, 0), c = 0, d = 0, e = 1, f = null; 1 > d;)d += .005 * e, f = r(a, d), c += s(f, b), b = f;
        return c
    }, w = function (a, b, c) {
        ...
        var c = r(a, b), d = r(a.slice(0, a.length - 1), b), e = d.y - c.y, f = d.x - c.x;
    ...
    var d = this, e = function (a, b, c) {
                ...
                if (null == a)return c;
                var f = a.split(","), i = function (d) {
                    i.__tauid = c.__tauid;
                    var j = g(d), k = j, l = h(d, j, b, null != a);
            ...
            }, q = {tap: {touches: 1, taps: 1}, dbltap: {touches: 1, taps: 2}, contextmenu: {touches: 2, taps: 1}},
            r = function (a, b) {
            ...
            }, u = "ontouchstart" in document.documentElement, v = "onmousedown" in document.documentElement,
            w = {mousedown: "touchstart", mouseup: "touchend", mousemove: "touchmove"}, x = function () {
                var a = -1;
    ...
    d.Mottle = function (a) {
        a = a || {};
        var b = a.clickThreshold || 250, d = a.dblClickThreshold || 450, e = new t, g = new r(b, d), h = a.smartClicks,
                i = function (a, b, c, d) {
                    null != c && I(a, function () {
                        var a = f(this);
        ...
        this.remove = function (a) {
            ...
            var g = v && ("undefined" == typeof MouseEvent || null == d || d.constructor === MouseEvent),
                    h = u && !v && w[b] ? w[b] : b, i = !(u && !v && w[b]), j = A(d), k = B(d), l = C(d);
            return I(a, function () {
                var a, m = f(this);
                d = d || {screenX: k[0], screenY: k[1], clientX: l[0], clientY: l[1]};
                var n = function (a) {
                    e && (a.payload = e)
                }, o = {
                ...
                if (document.createEvent) {
                    var p = !i && !g && u && w[b], q = p ? "TouchEvent" : "MouseEvents";
    ...
    var a = this, b = function (a, b, c) {
                ...
                return a
            }(), j = 10, k = 10, l = i > -1 && 9 > i, m = 9 === i, n = function (a) {
            ...
            }, r = "katavorio-drag-scope", s = ["stop", "start", "drag", "drop", "over", "out", "beforeStart"],
            t = function () {
            }, u = function () {
                return !0
            }, v = function (a, b, c) {
            ...
            }, z = "input,textarea,select,button,option", A = function (a, b, c) {
                ...
                var l = [0, 0], m = null, o = null, p = [0, 0], r = !1, s = [0, 0], t = this.params.consumeStartEvent !== !1,
                        v = this.el, x = this.params.clone, z = (this.params.scroll, b.multipleDrop !== !1), E = !1,
                        F = b.ghostProxy === !0 ? C : b.ghostProxy && "function" == typeof b.ghostProxy ? b.ghostProxy : D,
                        I = function (a) {
                            return a.cloneNode(!0)
                        }, J = b.selector, K = null, L = b.snapThreshold, M = function (a, b, c, d, e) {
                ...
                this.posses = [], this.posseRoles = {}, this.toGrid = function (a) {
                    ...
                    if (null != v) {
                        ...
                        var c = this.params.getPosition(v), d = this.params.grid ? this.params.grid[0] / 2 : L,
                ...
                var N, O = function (a) {
                    ...
                    N = "function" == typeof a ? a : a ? function (a, b, c, d) {
                        return O([Math.max(0, Math.min(c.w - d[0], a[0])), Math.max(0, Math.min(c.h - d[1], a[1]))])
                    }.bind(this) : function (a) {
                        return O(a)
                    }
                }.bind(this);
                P("function" == typeof this.params.constrain ? this.params.constrain : this.params.constrain || this.params.containment), this.setConstrain = function (a) {
                    P(a)
                };
                var Q;
                ...
                this.addFilter = U, this.removeFilter = function (a) {
                ...
                this.downListener = function (a) {
                    ...
                    if (b && this.isEnabled() && this.canDrag()) {
                        ...
                        if (d) {
                            if (J) {
                                if (K = h(this.el, a.target || a.srcElement, J), null == K)return
                            } else K = this.el;
                            if (x)if (v = K.cloneNode(!0), this.params.addClass(v, q.clonedDrag), v.setAttribute("id", null), v.style.position = "absolute", null != this.params.parent) {
                                var e = this.params.getPosition(this.el);
                                v.style.left = e[0] + "px", v.style.top = e[1] + "px", this.params.parent.appendChild(v)
                            } else {
                                var g = f(K);
                                v.style.left = g.left + "px", v.style.top = g.top + "px", document.body.appendChild(v)
                            } else v = K;
                            t && y(a), l = n(a), v && v.parentNode && (s = [v.parentNode.scrollLeft, v.parentNode.scrollTop]), this.params.bind(document, "mousemove", this.moveListener), this.params.bind(document, "mouseup", this.upListener), i.markSelection(this), i.markPosses(this), this.params.addClass(document.body, c.noSelect), Z("beforeStart", {
                                el: this.el,
                                pos: m,
                                e: a,
                                drag: this
                    ...
                    if (l) {
                        ...
                        if (l) {
                            X.length = 0;
                            var c = n(a), d = c[0] - l[0], e = c[1] - l[1], f = this.params.ignoreZoom ? 1 : i.getZoom();
                            v && v.parentNode && (d += v.parentNode.scrollLeft - s[0], e += v.parentNode.scrollTop - s[1]), d /= f, e /= f, this.moveBy(d, e, a), i.updateSelection(d, e, this), i.updatePosses(d, e, this)
                        }
                    }
                ...
                var Y = {start: [], drag: [], stop: [], over: [], out: [], beforeStart: [], revert: []};
                b.events.start && Y.start.push(b.events.start), b.events.beforeStart && Y.beforeStart.push(b.events.beforeStart), b.events.stop && Y.stop.push(b.events.stop), b.events.drag && Y.drag.push(b.events.drag), b.events.revert && Y.revert.push(b.events.revert), this.on = function (a, b) {
                    Y[a] && Y[a].push(b)
                }, this.off = function (a, b) {
                    if (Y[a]) {
                        for (var c = [], d = 0; d < Y[a].length; d++)Y[a][d] !== b && c.push(Y[a][d]);
                        Y[a] = c
                    }
                };
                var Z = function (a, b) {
                    var c = null;
                    if (Y[a])for (var d = 0; d < Y[a].length; d++)try {
                        var e = Y[a][d](b);
                        null != e && (c = e)
                    } catch (f) {
                    }
                ...
                this.notifyStart = function (a) {
                    Z("start", {el: this.el, pos: this.params.getPosition(v), e: a, drag: this})
                }, this.stop = function (a, b) {
                    if (b || r) {
                        var c = [], d = i.getSelection(), e = this.params.getPosition(v);
                        ...
                        Z("stop", {el: v, pos: $ || e, finalPos: e, e: a, drag: this, selection: c})
                    }
                }, this.mark = function (a) {
                    m = this.params.getPosition(v), o = this.params.getPosition(v, !0), p = [o[0] - m[0], o[1] - m[1]], this.size = this.params.getSize(v), W = i.getMatchingDroppables(this), w(W, !0, !1, this), this.params.addClass(v, this.params.dragClass || c.drag);
                    var b;
                    b = this.params.getConstrainingRectangle ? this.params.getConstrainingRectangle(v) : this.params.getSize(v.parentNode), V = {
                        w: b[0],
                        h: b[1]
                ...
                this.unmark = function (a, d) {
                    if (w(W, !1, !0, this), E && F(K) ? ($ = [v.offsetLeft, v.offsetTop], K.parentNode.removeChild(v), v = K) : $ = null, this.params.removeClass(v, this.params.dragClass || c.drag), W.length = 0, E = !1, !d) {
                    ...
                    X.length = 0;
                    var e = this.toGrid([m[0] + a, m[1] + c]), f = N(e, v, V, this.size);
                    if (F(this.el))if (e[0] !== f[0] || e[1] !== f[1]) {
                        if (!E) {
                            var g = I(K);
                            b.addClass(g, q.ghostProxy), K.parentNode.appendChild(g), v = g, E = !0
                        }
                        f = e
                    ...
                    for (var k = 0; k < W.length; k++) {
                        var l = {x: W[k].pagePosition[0], y: W[k].pagePosition[1], w: W[k].size[0], h: W[k].size[1]};
                        this.params.intersects(i, l) && (z || null == j || j === W[k].el) && W[k].canDrop(this) ? (j || (j = W[k].el), X.push(W[k]), W[k].setHover(this, !0, d)) : W[k].isHover() && W[k].setHover(this, !1, d)
                    }
                ...
                }, this.params.bind(this.el, "mousedown", this.downListener), this.params.handle ? U(this.params.handle, !1) : U(this.params.filter, this.params.filterExclude)
            }, F = function (a, b, c, d) {
                this._class = c.droppable, this.params = b || {}, this.rank = b.rank || 0, this._activeClass = this.params.activeClass || c.active, this._hoverClass = this.params.hoverClass || c.hover, B.apply(this, arguments);
                var e = !1;
                ...
                return null == a ? null : (a = "string" == typeof a || a.constructor === String ? document.getElementById(a) : a, null == a ? null : (a._katavorio = a._katavorio || G(), a))
            };
    a.Katavorio = function (a) {
        ...
        }.bind(this), m = {}, n = a.css || {}, o = a.scope || r;
        ...
        this.getInputFilterSelector = function () {
            ...
            var d = [];
            return x(b, function (b) {
                if (b = I(b), null != b)if (null == b._katavorioDrag) {
                    var e = k(c);
                    b._katavorioDrag = new E(b, e, m, o), i(b._katavorioDrag, this._dragsByScope), d.push(b._katavorioDrag), a.addClass(b, m.draggable)
        ...
        x(["set", "add", "remove", "toggle"], function (a) {
            this[a + "Scope"] = function (b, c) {
                y(b._katavorioDrag, c, this._dragsByScope, a + "Scope"), y(b._katavorioDrop, c, this._dropsByScope, a + "Scope")
    ...
    function l(b, e, g, h) {
        ...
        var n = k(b);
        for (j in e)if (null == n[j] || m[j]) n[j] = e[j]; else if (c(e[j]) || d(e[j])) l[j] ? (i = [], i.push.apply(i, a(n[j]) ? n[j] : [n[j]]), i.push.apply(i, d(e[j]) ? e[j] : [e[j]]), n[j] = i) : n[j] = e[j]; else if (a(e[j])) i = [], a(n[j]) && i.push.apply(i, n[j]), i.push.apply(i, e[j]), n[j] = i; else if (f(e[j])) {
            f(n[j]) || (n[j] = {});
                ...
                if (a.getDefaultType) {
                    ...
                    for (var j = 0, k = a._jsPlumb.types.length; k > j; j++) {
                        ...
                        if ("__default" !== l) {
                            ...
                            null != m && (i = b.merge(i, m, ["cssClass"], ["connector"]), h(f, m, l))
                        }
                    }
    ...
    var m = 0, n = function () {
        ...
        this.version = "2.8.6", this.Defaults = {
            Anchor: "Bottom",
            Anchors: [null, null],
    ...
    b.Connection = function (a) {
        ...
        this.getTypeDescriptor = function () {
            ...
            return null != a ? a.connectionsDetachable === !0 : this._jsPlumb.detachable === !0
                ...
                if (null == b || b !== this._jsPlumb.lastPaintedAt) {
                    ...
                    for (var o in this._jsPlumb.overlays)if (this._jsPlumb.overlays.hasOwnProperty(o)) {
                        ...
                        p.isVisible() && (this._jsPlumb.overlayPlacements[o] = p.draw(this.connector, this._jsPlumb.paintStyleInUse, this.getAbsoluteOverlayPosition(p)),
                                n.minX = Math.min(n.minX, this._jsPlumb.overlayPlacements[o].minX), n.maxX = Math.max(n.maxX, this._jsPlumb.overlayPlacements[o].maxX), n.minY = Math.min(n.minY, this._jsPlumb.overlayPlacements[o].minY), n.maxY = Math.max(n.maxY, this._jsPlumb.overlayPlacements[o].maxY))
                    }
    ...
    c.AnchorManager = function (a) {
        var d = {}, e = {}, f = {}, g = {}, h = this, i = {}, j = a.jsPlumbInstance, k = {},
                l = function (a, b, c, d, e, f, g) {
                    ...
                    top: function (a, b) {
                        return a[0] > b[0] ? 1 : -1
                    }, right: m(!0), bottom: m(!0), left: n
                }, p = function (a, b) {
                    return a.sort(b)
                }, q = function (a, b) {
                    var c = j.getCachedData(a), d = c.s, g = c.o, h = function (b, c, d, g, h, i, j) {
        ...
        this.reset = function () {
            ...
            var d = a.sourceId, e = a.targetId, f = a.endpoints, h = !0, i = function (i, j, k, l, m) {
        ...
        this.connectionDetached = function (a, c) {
            var d = a.connection || a, e = a.sourceId, f = a.targetId, i = d.endpoints, j = function (a, c, d, e, f) {
        ...
        this.updateOtherEndpoint = function (a, d, e, f) {
            ...
            if (!j.isSuspendDrawing()) {
                var n = d[a] || [], o = g[a] || [], p = [], r = [], t = [];
                f = f || j.timestamp(), h = h || {left: 0, top: 0}, e && (e = {
                    left: e.left + h.left,
                    top: e.top + h.top
                });
                for (var u = j.updateOffset({
                    ...
                    if (A || B) {
                        ...
                        A && !i[y] && (i[y] = {
                            ...
                            bottom: [],
                            left: []
                        }), a !== z && j.updateOffset({elId: z, timestamp: f}), a !== y && j.updateOffset({
                            elId: y,
                            timestamp: f
                        });
                        var F = j.getCachedData(z), G = j.getCachedData(y);
    ...
    b.Segments = {
        AbstractSegment: function (a) {
            ...
            this.lineIntersection = function (a, b, c, f) {
                var k = Math.abs(d.gradient({x: a, y: b}, {x: c, y: f})), l = Math.abs(e),
                        m = l === 1 / 0 ? g : i - l * g, n = [], p = k === 1 / 0 ? a : b - k * a;
        ...
        getPath: function (a, b) {
            return {
                Straight: function (b) {
                    ...
                    var c = a.params, d = a.sweep > Math.PI ? 1 : 0, e = a.anticlockwise ? 0 : 1;
    ...
    b.Connectors.AbstractConnector = function (a) {
        ...
        var v = function (a) {
            ...
            var b = d.quadrant(a.sourcePos, a.targetPos), c = a.targetPos[0] < a.sourcePos[0],
                    ...
                    i = c ? a.targetPos[0] : a.sourcePos[0], j = e ? a.targetPos[1] : a.sourcePos[1],
                    m = Math.abs(a.targetPos[0] - a.sourcePos[0]), p = Math.abs(a.targetPos[1] - a.sourcePos[1]);
    ...
    c.extend(f, b.jsPlumbUIComponent, {
        ...
        this._jsPlumb.img = new Image, this._jsPlumb.ready = !1, this._jsPlumb.initialized = !1,
                this._jsPlumb.deleted = !1, this._jsPlumb.widthToUse = d.width, this._jsPlumb.heightToUse = d.height, this._jsPlumb.endpoint = d.endpoint, this._jsPlumb.img.onload = function () {
    ...
    var a = this, b = a.jsPlumbUtil, c = a.jsPlumbInstance, d = "jtk-group-collapsed", e = "jtk-group-expanded",
            ...
            k = "_jsPlumbGroup", l = "_jsPlumbGroupDrag", m = "group:addMember", n = "group:removeMember",
            o = "group:add", p = "group:remove", q = "group:expand", r = "group:collapse", s = "groupDragStop",
            t = "connectionMoved", u = "internal.connectionDetached", v = "removeAll", w = "orphanAll", x = "show",
            y = "hide", z = function (a) {
                function c(a) {
                    delete a.proxies;
                    var c, d = i[a.id];
                ...
                var v = this.getDragArea = function () {
                        ...
                        }, w = d.ghost === !0, x = w || d.constrain === !0, y = d.revert !== !1, z = d.orphan === !0,
                        A = d.prune === !0, B = d.dropOverride === !0, C = d.proxied !== !1, D = [];
